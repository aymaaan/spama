...
<head>
  ...
  <title>Login Page - {{config('settings.sitename')}}
  </title>
              ...
              <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                  <div class="card-title text-center">
                    <div class="p-1">
                      <img style="width:100%" src="{{url(config('settings.logo'))}}" alt="branding logo">
                    </div>
                  </div>
                ...
                <div class="card-content">
                  <div class="card-body">
                     ...
                     {!! Form::open(["url"=> route('login')  , "class"=>"form-horizontal form-simple" ])  !!}
                    ...
                    @endif
                      ...
                      <div class="form-group row">
                        ...
                        </div><div class="col-md-6 col-12 float-sm-left text-center text-sm-right"><a href="{{url('password/reset')}}" class="card-link">?Forgot Password</a></div>
