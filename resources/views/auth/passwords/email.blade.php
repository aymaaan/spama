              ...
              <div class="card border-grey border-lighten-3 m-0">
                ...
                <div class="card-content">
                  <div class="card-body">
                    ...
                    <form method="POST" class="form-horizontal form-simple" action="{{ route('password.email') }}" aria-label="{{ __('Reset Password') }}">

                       {{ csrf_field() }}

                      <fieldset class="form-group position-relative has-icon-left mb-0">
                        <input type="text" class="form-control form-control-lg input-lg" id="user-name" name="email" value="{{ old('email') }}" placeholder="Email"
                        required>
                      ...
                      <button type="submit" class="btn btn-info btn-lg btn-block"><i class="la la-key"></i> Send Password Reset Link</button>
                    </form>
