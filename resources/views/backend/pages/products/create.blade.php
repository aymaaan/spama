...
{!! Form::open([ 'route' => 'products.store', 'role' => 'form' , 'class' => 'form' ,  'files' => 'true' ]) !!}  
  ...
  <div class="col-md-3">
    <div class="form-group">
      ...
      <select  id="brand_id" name="brand_id" required  class="form-control">
        ...
        <option title_ar ="{{$brand->title}}" title_en ="{{$brand->title_en}}" serial="{{$brand->serial}}"  value="{{$brand->serial}}">{{$brand->title}}</option>
        @endforeach
...
<h4 class="form-section"><i class="la la-commenting"></i>  {{ __('backend.names') }} &  SKU </h4>
...
<h4 style="color:red;" class="form-section"><i class="la la-commenting"></i>  {{ __('backend.old_names') }} &  SKU </h4>

<div id="features_div" class="row">

<div class="col-md-4">
  <div class="form-group">
    <label for="projectinput3">   {{ __('backend.product_name_ar') }}   السابق    </label>

    {!! Form::text('title_ar_old', null , ['id'=>'title_ar', 'class' => 'form-control' , 'placeholder'=>  __('backend.arabic_title')   ] ) !!}
...
<div class="col-md-4">
  <div class="form-group">
    <label for="projectinput3">{{ __('backend.product_name_en') }} السابق </label>

    {!! Form::text('title_en_old', null , ['id'=>'title_en', 'class' => 'form-control' , 'placeholder'=>  __('backend.english_title')   ] ) !!}
...
<div class="col-md-3">
  <div class="form-group">
    ...
    {!! Form::text('sku_old', null , ['id'=>'sku', 'class' => 'form-control' , 'placeholder'=> 'SKU' ] ) !!}
...
<div class="col-md-2">
    <div class="form-group">
      ...
      {!! Form::select('unit_id[]', $units ,  null , ['id'=>'unit_id', 'class' => 'form-control' , 'placeholder'=> __('backend.unit') ] ) !!}
    </div>
  </div>
...
<div class="col-md-3">
  <div class="form-group">
    ...
    {!! Form::text('last_purchase_price', null , ['id'=>'units', 'class' => 'form-control' , 'placeholder'=> __('backend.last_purchase_price') ] ) !!}
...
<div class="col-md-3">
  <div class="form-group">
    ...
    {!! Form::text('average_purchase_price', null , ['id'=>'units', 'class' => 'form-control' , 'placeholder'=> __('backend.average_purchase_price') ] ) !!}
...
<div class="col-md-3">
  <div class="form-group">
    ...
    {!! Form::select('value_added', ['Yes'=>'Yes' , 'No'=>'No'] , null , ['id'=>'units', 'class' => 'form-control' , 'placeholder'=> __('backend.value_added') ] ) !!}
...
<div class="form-group  col-md-8">
     ...
     <select  name='local_suppliers_id[]' class="select2 form-control" multiple="multiple">
                   ...
                   <option @if(isset($data->products_local_suppliers))
                  @foreach ( $data->products_local_suppliers as $supplier )
                  @if ($supplier->id == $row->id) selected @endif
                  @endforeach 
...
<div class="form-group  col-md-8">
     ...
     <select  name='foreign_suppliers_id[]' class="select2 form-control" multiple="multiple">
                   ...
                   <option @if(isset($data->products_foreign_suppliers))
                  @foreach ( $data->products_foreign_suppliers as $supplier )
                  @if ($supplier->id == $row->id) selected @endif
                  @endforeach 
                  @endif value="{{$row->id}}">{{$row->name}}</option>
                   @endforeach
...
<div class="col-md-3">
  <div class="form-group">
    ...
    {!! Form::date('expiration_date', null , ['id'=>'expiration_date', 'class' => 'form-control' , 'placeholder'=>  __('backend.expiration_date')   ] ) !!}
...
<div class="col-md-3">
  <div class="form-group">
    ...
    {!! Form::date('production_date', null , ['id'=>'production_date', 'class' => 'form-control' , 'placeholder'=>  __('backend.production_date')   ] ) !!}
...
<div class="col-md-3">
  <div class="form-group">
    ...
    {!! Form::number('loot_number', null , ['id'=>'loot_number', 'class' => 'form-control' , 'placeholder'=>  __('backend.loot_number')   ] ) !!}
...
<div class="row">
  <div class="col-sm-2">{!! Form::text('product_package_dimensions_x', null , ['id'=>'product_package_dimensions', 'class' => 'form-control' , 'placeholder'=>  'X'  ] ) !!}</div>
  <div class="col-sm-2">{!! Form::text('product_package_dimensions_y', null , ['id'=>'product_package_dimensions', 'class' => 'form-control' , 'placeholder'=>  'Y'   ] ) !!}</div>
  <div class="col-sm-2">{!! Form::text('product_package_dimensions_z', null , ['id'=>'product_package_dimensions', 'class' => 'form-control' , 'placeholder'=> 'Z'   ] ) !!}</div>
</div>
...
<div class="col-md-4">
  <div class="form-group">
    ...
    {!! Form::text('sku_supplier', null , ['id'=>'package_unit', 'class' => 'form-control' , 'placeholder'=>  __('backend.sku_supplier')   ] ) !!}
...
<div class="col-md-4">
  <div class="form-group">
    ...
    {!! Form::text('total_quantity', null , ['id'=>'package_unit', 'class' => 'form-control' , 'placeholder'=>  __('backend.total_quantity')   ] ) !!}
...
<div class="col-md-4">
  <div class="form-group">
    ...
    {!! Form::text('minimum_total_quantity', null , ['id'=>'package_unit', 'class' => 'form-control' , 'placeholder'=>  __('backend.minimum_total_quantity')   ] ) !!}
...
<div class="col-md-4">
  <div class="form-group">
    ...
    {!! Form::text('maximum_total_quantity', null , ['id'=>'package_unit', 'class' => 'form-control' , 'placeholder'=>  __('backend.maximum_total_quantity')   ] ) !!}
...
<div class="col-md-4">
  <div class="form-group">
    ...
    {!! Form::text('total_demand_limit', null , ['id'=>'total_demand_limit', 'class' => 'form-control' , 'placeholder'=>  __('backend.total_demand_limit')   ] ) !!}
...
<div class="col-md-4">
  <div class="form-group">
    ...
    {!! Form::number('delivery_period_main_repository', null , ['id'=>'delivery_period_main_repository', 'class' => 'form-control' , 'placeholder'=>  __('backend.delivery_period_main_repository')   ] ) !!}
...
<div class="col-md-4">
  <div class="form-group">
    ...
    {!! Form::text('special_price_realted_by_another_product', null , ['id'=>'special_price_realted_by_another_product', 'class' => 'form-control'  , 'placeholder'=>  __('backend.special_price_realted_by_another_product')     ] ) !!}
...
<div class="col-md-4">
  <div class="form-group">
    ...
    {!! Form::text('cost_price', null , ['id'=>'cost_price', 'class' => 'form-control'  , 'placeholder'=>  __('backend.cost_price')     ] ) !!}
...
<div class="col-md-4">
  <div class="form-group">
    ...
    <option  >-----</option>
                     ...
                     <option  value="{{$row->price}}">Quantity : {{ $row->quantity }} - Price : {{ $row->price }}</option>
                      @endforeach
...
<div class="col-md-4">
  <div class="form-group">
    ...
    {!! Form::text('additional_costs_related_by_product', null , ['id'=>'additional_costs_related_by_product', 'class' => 'form-control'  , 'placeholder'=>  __('backend.additional_costs_related_by_product')     ] ) !!}
...
<div class="col-md-4">
  <div class="form-group">
    ...
    {!! Form::text('shipping_charges', null , ['id'=>'shipping_charges', 'class' => 'form-control'  , 'placeholder'=>  __('backend.shipping_charges')     ] ) !!}
...
<div class="col-md-4">
  <div class="form-group">
    ...
    {!! Form::text('cod_charges', null , ['id'=>'cod_charges', 'class' => 'form-control'  , 'placeholder'=>  __('backend.cod_charges')     ] ) !!}
...
<input type="file" multiple="multiple" name="{{$field->name}}[]"  />
                              ...
                              {!! Form::text(  $field->name , null , ['class' => 'form-control' , 'placeholder'=>  $field->label_ar ] ) !!}
