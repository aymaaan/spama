...
{!! Form::model( $data ,[ 'url' =>  config('settings.BackendPath').'/suppliers/'.$data->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]) !!}  

@include('backend.pages.suppliers.form')
...
$(document).ready(function(){
  ...
  @if( isset($data) && $data->supplier_type == 'داخلى' ) 
