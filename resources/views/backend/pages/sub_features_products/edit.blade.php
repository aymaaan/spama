...
{!! Form::model( $data ,[ 'url' =>  config('settings.BackendPath').'/sub-features-products/'.$data->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]) !!}  

@include('backend.pages.sub_features_products.form')
