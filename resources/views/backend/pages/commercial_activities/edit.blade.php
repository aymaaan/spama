              ...
              <div class="card">
                <div class="card-head">
                  <div class="card-header">
                    <h4 class="card-title">  {{__('backend.commercial_activities')}}    </h4>
...
{!! Form::model( $data ,[ 'url' =>  config('settings.BackendPath').'/commercial_activities/'.$data->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]) !!}  

@include('backend.pages.commercial_activities.form')
