...
<div class="row">
          ...
          <div class="col-xl-4 col-lg-4 col-12">
            <div class="card pull-up">
              <div class="card-content">
                <a href="{{url(config('settings.BackendPath'))}}/list-mother-products">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="info"> --- </h3>
                      <h5>{{__('backend.mother_products')}}</h5>
                    </div>
                    <div>
                      <i class="icon-basket-loaded info font-large-2 float-right"></i>
                    </div>
          ...
          <div class="col-xl-4 col-lg-4 col-12">
            <div class="card pull-up">
              <div class="card-content">
                <a href="{{url(config('settings.BackendPath'))}}/brands">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="info"> --- </h3>
                      <h5> {{__('backend.brands')}}  </h5>
                    </div>
                    <div>
                      <i class="icon-basket-loaded info font-large-2 float-right"></i>
                    </div>
              ...
              <div class="card-content">
                ...
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="info"> --- </h3>
                      <h5>{{__('backend.universal_barcode')}}</h5>
                    </div>
                    <div>
                      <i class="icon-basket-loaded info font-large-2 float-right"></i>
                    </div>
          ...
          <div class="col-xl-4 col-lg-4 col-12">
            <div class="card pull-up">
              <div class="card-content">
                <a href="{{url(config('settings.BackendPath'))}}/websites">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="info"> --- </h3>
                      <h5> {{__('backend.websites')}}  </h5>
                    </div>
                    <div>
                      <i class="icon-basket-loaded info font-large-2 float-right"></i>
                    </div>
