...
<div class="col-xl-4 col-lg-4 col-12">
                ...
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="info"> --- </h3>
                      <h5>  {{__('backend.list_purchase_orders')}}      </h5>
                    </div>
                    <div>
              ...
              <div class="card-content">
                ...
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="info"> --- </h3>
                      <h5> {{__('backend.add_purchase_orders')}} </h5>
                    </div>
                    <div>
                      <i class="icon-basket-loaded info font-large-2 float-right"></i>
                    </div>
              ...
              <div class="card-content">
                ...
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="info"> --- </h3>
                      <h5> {{__('backend.pending_purchase_orders')}}   </h5>
                    </div>
                    <div>
                      <i class="icon-basket-loaded info font-large-2 float-right"></i>
                    </div>
          ...
          <div class="col-xl-4 col-lg-4 col-12">
            <div class="card pull-up">
              <div class="card-content">
                <a href="{{url(config('settings.BackendPath'))}}/suppliers">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="info"> --- </h3>
                      <h5> {{__('backend.suppliers')}} </h5>
                    </div>
                    <div>
                      <i class="icon-basket-loaded info font-large-2 float-right"></i>
                    </div>
