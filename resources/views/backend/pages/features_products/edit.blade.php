...
{!! Form::model( $data ,[ 'url' =>  config('settings.BackendPath').'/features-products/'.$data->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]) !!}  

@include('backend.pages.features_products.form')
