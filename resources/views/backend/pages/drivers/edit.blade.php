          ...
          <div class="card">
            ...
            <div class="card-content">
              <div class="card-body">
                ...
                {!! Form::model( $data[0] ,[ 'url' =>  config('settings.BackendPath').'/drivers/'.$data[0]->user_id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]) !!}
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            {!! Form::text('id_number', null , ['class' => 'form-control' , 'placeholder'=> __('backend.id_number')] ) !!}
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <a data-toggle="modal" data-target="#photoModal{{$photo->id}}" href="#">
                                <img src="{{url('')}}/uploads/drivers_photos/{{$data[0]->id}}/{{$photo->photo_name}}"   width="150">
                              </a>

                              <br>

                              <a target="_blank" href="{{url('')}}/{{config('settings.BackendPath')}}/drivers/photos/delete/{{$photo->id}}" style="color:#fff;" type="button" class="btn btn-danger" data-dismiss="modal">Delete</a>
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <img src="{{url('')}}/uploads/drivers_photos/{{$data[0]->id}}/{{$photo->photo_name}}"   width="100%">
