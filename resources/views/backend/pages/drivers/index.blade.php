                            ...
                            <div class="card-header">
                                ...
                                @can('create_drivers')
                                    <div class="heading-elements">
                                        <a href="{{url(config('settings.BackendPath').'/drivers/create')}}">
                                            <button class="btn btn-primary btn">
                                                <i class="la la-plus-square-o"></i> {{__('backend.add_driver')}}   </button>
                                        </a> </div>
                                @endcan
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <table id="drivers-contacts" style='width:100%;' class="table datatable table-hover table-responsive">
                                    ...
                                    @foreach ( $drivers->where('id','!=',1) as $user )
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$user->phone}}</td>
                                            <td>
                                                @if($user->driver['photo'] != '')
                                                <img src="{{url('')}}/uploads/driver_photos/{{$user->driver['photo']}}"   width="64px"height="64px"></td>
@else
                                                <img src="{{url('')}}/assets/backend/users/images/default.png"   width="64px"height="64px"></td>
@endif
                                            ...
                                            <td>
                                                ...
                                                @can('delete_drivers')
                                                    <a href="{{url('')}}/{{config('settings.BackendPath')}}/drivers/{{$user->id}}/delete" class="badge badge badge-danger float-right"><i class="la la-trash"></i> </a>
                                                @endcan


                                                @can('update_drivers')
                                                    <a href="{{url('')}}/{{config('settings.BackendPath')}}/drivers/{{$user->id}}/edit" class="badge badge badge-info float-right"><i class="la la-pencil"></i> </a>
                                                @endcan
