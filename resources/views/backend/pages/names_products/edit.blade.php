...
{!! Form::model( $data ,[ 'url' =>  config('settings.BackendPath').'/names-products/'.$data->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]) !!}  

@include('backend.pages.names_products.form')
...
@section('head')
        ...
        <title> Names-Mother-Products | {{config('settings.sitename')}}</title>
