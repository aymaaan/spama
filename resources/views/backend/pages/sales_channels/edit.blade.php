              ...
              <div class="card">
                <div class="card-head">
                  <div class="card-header">
                    <h4 class="card-title">  {{__('backend.sales_channels')}}    </h4>
...
{!! Form::model( $data ,[ 'url' =>  config('settings.BackendPath').'/sales_channels/'.$data->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]) !!}  

@include('backend.pages.sales_channels.form')
