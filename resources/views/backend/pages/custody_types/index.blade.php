        ...
        <div class="card">
          <div class="card-head">
            <div class="card-header">
              <h4 class="card-title"> <B>   {{__('backend.custody_types')}}     </B></h4>
              <a class="heading-elements-toggle"><i class="la la-ellipsis-h font-medium-3"></i></a>
              @can('create_custody_types')
              <div class="heading-elements">
                <a href="{{url('')}}/{{config('settings.BackendPath')}}/custody_types/create">


                  <button class="btn btn-primary btn">
                    <i class="la la-plus-square-o"></i>    {{__('backend.add_custody_types')}}    </button>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          @can('delete_custody_types') 
                          <a title="Delete Post" href="{{url(config('settings.BackendPath').'/custody_types/'.$row->id.'/delete')}}" class="badge badge badge-danger float-right"><i class="la la-trash"></i> </a>
                          @endcan

                          @can('update_custody_types') 
                              <a href="{{url('')}}/{{config('settings.BackendPath')}}/custody_types/{{$row->id}}/edit" class="badge badge badge-info float-right"><i class="la la-pencil"></i> </a>
                           @endcan
