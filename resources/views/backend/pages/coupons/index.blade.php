        ...
        <div class="card">
          <div class="card-head">
            <div class="card-header">
              <h4 class="card-title"> <B>   {{__('backend.coupons')}}     </B></h4>
              ...
              <div class="heading-elements">
                <a href="{{url('')}}/{{config('settings.BackendPath')}}/coupons/create">
                  ...
                  <button class="btn btn-primary btn">
                    <i class="la la-plus-square-o"></i>    {{__('backend.add_coupons')}} / {{__('backend.campaign')}}   </button>
                  ...
                  <table id="users-contacts" style='width:100%;' class="table datatable table-hover table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td> <a  href="{{url(config('settings.BackendPath').'/coupons/list/'.str_replace(' ' , '-' , $row->title ))}}" > {{$row->title}} </a></td>
