              ...
              <div class="card">
                <div class="card-head">
                  <div class="card-header">
                    <h4 class="card-title">  {{ __('backend.languages') }}    </h4>
...
{!! Form::open([ 'url' => config('settings.BackendPath').'/languages/words/'.$lang, 'role' => 'form' , 'class' => 'form' ,  'files' => 'true' ]) !!}  
...
<h4 class="form-section"><i class="la la-commenting"></i>   {{ __('backend.translate_words') }}      </h4>
...
<input type="text" name="{{$k}}" value="{{$row OR $k }}" class="form-control" >
