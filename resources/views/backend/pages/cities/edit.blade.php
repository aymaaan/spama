...
{!! Form::model( $data ,[ 'url' =>  config('settings.BackendPath').'/cities/'.$data->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]) !!}  

@include('backend.pages.cities.form')
...
@section('head')
        ...
        <title> {{__('backend.cities')}} | {{config('settings.sitename')}}</title>
