    ...
    <div class="app-content content">
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                        ...
                        <h4 class="card-title"><B>   {{__('backend.map_review')}}     </B></h4>
...
@section('scripts')
    ...
    <script async defer
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB7n99W41rc00c8Fmp4nHrr6aLE-G88e5E&amp;libraries=places">
    </script>
@endsection