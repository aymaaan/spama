                    ...
                    <div class="card">
                        <div class="card-head">
                            <div class="card-header">
                                <h4 class="card-title"><B>   {{__('backend.confirmed_orders')}}     </B></h4>
                        ...
                        <div class="card-content">
                            ...
                            <form action="{{url(config('settings.BackendPath').'/orders/confirmed/order')}}"
                                  method="GET">
                                <div class="row">
                                    <div class="col-md-2">
...
{{$driverName->data['serial']}}
                                            ...
                                            <td>
                                                @php
                                                    $city =  \App\City::find($row->city_id);
                                                @endphp
                                                {{$city->title_en}}
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                @endcan
                                                {{--                                                    @can('update_orders')--}}
                                                {{--                                                        <a href="{{url('')}}/{{config('settings.BackendPath')}}/orders/details/{{$row->id}}" class="badge badge badge-info float-right"><i class="la la-eye"></i>    </a>--}}
                                                {{--                                                    @endcan--}}
