              ...
              <div class="card-body">
                ...
                @foreach($dataStop as $stop)
                    <ul class="nav nav-tabs nav-topline">
                      ...
                      <li class="nav-item">
                        <a style="width: 200px;" class="nav-link @if ($stop->stop_type == 'branch') active @endif" id="home-tab2" data-toggle="tab" href="#home2"
                           aria-controls="home2"
                      ...
                      <li class="nav-item">
                        <a style="width: 200px;" class="nav-link @if ($stop->stop_type == 'customer') active @endif" id="profile-tab2" data-toggle="tab" href="#profile2"
                      ...
                      <li class="nav-item">
                        <a style="width: 200px;" class="nav-link @if ($stop->stop_type == 'other') active @endif"  id="websites_properties-tab2" data-toggle="tab"
