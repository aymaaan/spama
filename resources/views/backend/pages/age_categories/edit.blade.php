              ...
              <div class="card">
                <div class="card-head">
                  <div class="card-header">
                    <h4 class="card-title">  {{__('backend.age_categories')}}  </h4>
...
{!! Form::model( $data ,[ 'url' =>  config('settings.BackendPath').'/age_categories/'.$data->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]) !!}  

@include('backend.pages.age_categories.form')
