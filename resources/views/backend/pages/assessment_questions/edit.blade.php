              ...
              <div class="card">
                <div class="card-head">
                  <div class="card-header">
                    <h4 class="card-title">  {{__('backend.assessment_questions')}}  </h4>
...
{!! Form::model( $data ,[ 'url' =>  config('settings.BackendPath').'/assessment_questions/'.$data->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]) !!}  

@include('backend.pages.assessment_questions.form')
