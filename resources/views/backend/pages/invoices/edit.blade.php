                ...
                <section class="card">
                    <div id="invoice-template" class="card-body">
                        ...
                        <div id="invoice-customer-details" class="row pt-2">
                            <div class="col-md-3"><h3> {{ __('backend.customer_name') }}</h3>
                                <h4>{{ $data->customer_name}}</h4>
                            </div>
                            <div class="col-md-3"><h3> {{ __('backend.customer_tax') }}</h3>
                                <p>{{ $data->customer_tax}}</p>
                            </div>
                        ...
                        <div id="invoice-footer">
                            <div class="row">
                                ...
                                <div class="col-md-5 col-sm-12 text-center">
                                    <form method="get" action="{{url('')}}/{{config('settings.BackendPath')}}/invoices/{{$data->id}}/print">
                                        <button  style="float:left;color:#fff;" class="btn btn-success print-window">  طباعة    </button>
...
@section('head')
    ...
    <link rel="stylesheet" type="text/css"
          href="{{url('')}}/assets/app-assets/vendors/css/tables/datatable/datatables.min.css">
    <!-- END VENDOR CSS-->
    <!-- BEGIN MODERN CSS-->
...
@section('scripts')
    ...
    <script src="{{url('')}}/assets/app-assets/vendors/js/tables/datatable/datatables.min.js"
