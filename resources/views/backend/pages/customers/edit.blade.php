              ...
              <div class="card">
                <div class="card-head">
                  <div class="card-header">
                    <h4 class="card-title">   {{ __('backend.customers') }}   </h4>
...
{!! Form::model( $data ,[ 'url' =>  config('settings.BackendPath').'/customers/'.$data->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]) !!}  

@include('backend.pages.customers.form')
