              ...
              <div class="card">
                <div class="card-head">
                  <div class="card-header">
                    <h4 class="card-title">  <?php echo e(__('backend.languages')); ?>    </h4>
...
<?php echo Form::open([ 'url' => config('settings.BackendPath').'/languages/words/'.$lang, 'role' => 'form' , 'class' => 'form' ,  'files' => 'true' ]); ?>  
...
<h4 class="form-section"><i class="la la-commenting"></i>   <?php echo e(__('backend.translate_words')); ?>      </h4>
...
<input type="text" name="<?php echo e($k); ?>" value="<?php echo e(isset($row) ? $row : $k); ?>" class="form-control" >
