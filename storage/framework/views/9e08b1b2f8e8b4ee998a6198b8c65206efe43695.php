...
<?php echo Form::open([ 'route' => 'cities.store', 'role' => 'form' , 'class' => 'form' ,  'files' => 'true' ]); ?>  
  
<?php echo $__env->make('backend.pages.cities.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
