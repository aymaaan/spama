              ...
              <div class="card">
                <div class="card-head">
                  <div class="card-header">
                    <h4 class="card-title">    <?php echo e(__('backend.commercial_activities')); ?>    </h4>
...
<?php echo Form::open([ 'route' => 'commercial_activities.store', 'role' => 'form' , 'class' => 'form' ,  'files' => 'true' ]); ?>  
  
<?php echo $__env->make('backend.pages.commercial_activities.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
