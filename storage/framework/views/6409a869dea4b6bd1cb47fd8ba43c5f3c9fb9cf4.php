                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <?php echo Form::open([ 'route' => 'drivers.store', 'role' => 'form' , 'class' => 'form' ,  'files' => 'true' ]); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo Form::number('id_number', null , ['class' => 'form-control' , 'placeholder'=> __('backend.id_number')] ); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <label for="projectinput3">  <?php echo e(__('backend.photo_drive')); ?>  </label>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-group">
                                                        <p><strong><?php echo e(__('backend.notes_photo')); ?></strong></p>
