...
<div class="app-content content">
  <div class="content-body">
    <section class="row">
        ...
        <div class="card">
          <div class="card-head">
            <div class="card-header">
              <h4 class="card-title">    <?php echo e(__('backend.mother_products')); ?>    
              
               | 

               <?php if( $AppLangUser == 'ar' ): ?>
               <?php echo e(isset($category->title) ? $category->title : ''); ?> 
               <?php else: ?>
               <?php echo e(isset($category->title_en) ? $category->title_en : ''); ?>

               <?php endif; ?>
               
                | <B>  <?php echo e(__('backend.names')); ?>  <B></h4>
              <a class="heading-elements-toggle"><i class="la la-ellipsis-h font-medium-3"></i></a>
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create_mother_products')): ?>
              <?php if( $data->count() < 9 ): ?>
              <div class="heading-elements">
                <a href="<?php echo e(url('')); ?>/<?php echo e(config('settings.BackendPath')); ?>/names-products/create?cat=<?php echo e($_GET['cat']); ?>">
                  <button class="btn btn-primary btn">
                    <i class="la la-plus-square-o"></i>      <?php echo e(__('backend.add_product_name')); ?>      </button>
                  </a> </div> 
                  <?php endif; ?>
              <?php endif; ?>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_mother_products')): ?> 
                          <a title="Delete Post" href="<?php echo e(url(config('settings.BackendPath').'/names-products/'.$row->id.'/delete')); ?>" class="badge badge badge-danger float-right"><i class="la la-trash"></i> </a>
                          <?php endif; ?>



                          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update_mother_products')): ?> 
                          <?php if($row->status == 1 ): ?>
                          <a title='Block categories' href="<?php echo e(url(config('settings.BackendPath').'/names-products/approve/'.$row->id.'/0')); ?>" class="badge badge badge-success float-right"><i class="la la-check"></i> </a>
                          <?php else: ?>
                          <a title='Publish categories' href="<?php echo e(url(config('settings.BackendPath').'/names-products/approve/'.$row->id.'/1')); ?>" class="badge badge badge-danger float-right"><i class="la la-ban "></i> </a>
                          <?php endif; ?>
                          <?php endif; ?>
                           ...
                           <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update_mother_products')): ?> 
                              <a href="<?php echo e(url('')); ?>/<?php echo e(config('settings.BackendPath')); ?>/names-products/<?php echo e($row->id); ?>/edit" class="badge badge badge-info float-right"><i class="la la-pencil"></i> </a>
                           <?php endif; ?>




                   <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('features_products')): ?> 

                  <a href="<?php echo e(url('')); ?>/<?php echo e(config('settings.BackendPath')); ?>/features-products?cat=<?php echo e($row->id); ?>">
                  <button class="btn btn-success btn">
                  <?php echo e(__('backend.features')); ?>   <span class="badge badge badge-dark  badge-pill float-right mr-2"> <?php echo e(count( $row->features )); ?>  </span></button>
                  </a> 
      ...
      <title> <?php echo e(__('backend.names')); ?> | <?php echo e(config('settings.sitename')); ?></title>
