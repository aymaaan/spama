...
<head>
  ...
  <title>Login Page - <?php echo e(config('settings.sitename')); ?>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo e(url('')); ?>/assets/app-assets/css-rtl/pages/login-register.css">
  <!-- END Page Level CSS-->
  <!-- BEGIN Custom CSS-->
...
data-open="click" data-menu="vertical-menu" data-col="1-column">
              ...
              <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                  <div class="card-title text-center">
                    <div class="p-1">
                      <img style="width:100%" src="<?php echo e(url(config('settings.logo'))); ?>" alt="branding logo">
                    </div>
                  </div>
                  <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
                    <span><?php echo e(config('settings.sitename')); ?></span>
                  </h6>
                </div>
                <div class="card-content">
                  <div class="card-body">

                     <?php echo Form::open(["url"=> route('login')  , "class"=>"form-horizontal form-simple" ]); ?>
                    ...
                    <?php endif; ?>
                      ...
                      <div class="form-group row">
                        ...
                        </div><div class="col-md-6 col-12 float-sm-left text-center text-sm-right"><a href="<?php echo e(url('password/reset')); ?>" class="card-link">?Forgot Password</a></div>
                       
                      </div>
                      <button type="submit" class="btn btn-info btn-lg btn-block"><i class="la la-key"></i> Login</button>
                    <?php echo Form::close(); ?>
  ...
  <script src="<?php echo e(url('')); ?>/assets/app-assets/vendors/js/forms/validation/jqBootstrapValidation.js"
  ...
  <!-- END MODERN JS-->
  <!-- BEGIN PAGE LEVEL JS-->
  <script src="<?php echo e(url('')); ?>/assets/app-assets/js/scripts/forms/form-login-register.js" type="text/javascript"></script>
  <!-- END PAGE LEVEL JS-->
</body>
</html>