              ...
              <div class="card">
                <div class="card-head">
                  <div class="card-header">
                    <h4 class="card-title">  <?php echo e(__('backend.doctors')); ?>  </h4>
...
<?php echo Form::model( $data ,[ 'url' =>  config('settings.BackendPath').'/doctors/'.$data->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]); ?>  

<?php echo $__env->make('backend.pages.doctors.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
