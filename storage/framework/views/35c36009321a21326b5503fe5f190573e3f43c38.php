                    ...
                    <div class="card">
                        <div class="card-head">
                            <div class="card-header">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create_drivers')): ?>
                                    <div class="heading-elements">
                                        <a href="<?php echo e(url(config('settings.BackendPath').'/drivers/create')); ?>">
                                            <button class="btn btn-primary btn">
                                                <i class="la la-plus-square-o"></i> <?php echo e(__('backend.add_driver')); ?>   </button>
                                        </a> </div>
                                <?php endif; ?>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <table id="drivers-contacts" style='width:100%;' class="table datatable table-hover table-responsive">
                                    <thead>
                                    <tr>
                                        ...
                                        <th> <?php echo e(__('backend.photo')); ?> </th>
                                    ...
                                    <?php $__currentLoopData = $drivers->where('id','!=',1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($user->driver['photo'] != ''): ?>
                                                <img src="<?php echo e(url('')); ?>/uploads/driver_photos/<?php echo e($user->driver['photo']); ?>"   width="64px"height="64px"></td>
<?php else: ?>
                                                <img src="<?php echo e(url('')); ?>/assets/backend/users/images/default.png"   width="64px"height="64px"></td>
<?php endif; ?>
                                            ...
                                            <td>
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_drivers')): ?>
                                                    <a href="<?php echo e(url('')); ?>/<?php echo e(config('settings.BackendPath')); ?>/drivers/<?php echo e($user->id); ?>/delete" class="badge badge badge-danger float-right"><i class="la la-trash"></i> </a>
                                                <?php endif; ?>


                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update_drivers')): ?>
                                                    <a href="<?php echo e(url('')); ?>/<?php echo e(config('settings.BackendPath')); ?>/drivers/<?php echo e($user->id); ?>/edit" class="badge badge badge-info float-right"><i class="la la-pencil"></i> </a>
                                                <?php endif; ?>
