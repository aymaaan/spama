...
<?php echo Form::model( $user ,[ 'url' =>  config('settings.BackendPath').'/users/'.$user->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]); ?>  

<?php echo $__env->make('backend.pages.settings.users.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('head'); ?>
        ...
        <title> <?php echo e(__('backend.users')); ?> | <?php echo e(config('settings.sitename')); ?></title>
