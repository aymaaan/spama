              ...
              <div class="card">
                <div class="card-head">
                  <div class="card-header">
                    <h4 class="card-title">  <?php echo e(__('backend.branches')); ?>    </h4>
...
<?php echo Form::model( $data ,[ 'url' =>  config('settings.BackendPath').'/branches/'.$data->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]); ?>  

<?php echo $__env->make('backend.pages.branches.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
