              ...
              <div class="card">
                <div class="card-head">
                  <div class="card-header">
                    <h4 class="card-title"> <?php echo e(__('backend.categories')); ?> </h4>
...
<?php echo Form::model( $data ,[ 'url' =>  config('settings.BackendPath').'/categories/'.$data->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]); ?>  

<?php echo $__env->make('backend.pages.categories.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('head'); ?>
        ...
        <title><?php echo e(__('backend.categories')); ?> | <?php echo e(config('settings.sitename')); ?></title>
