              ...
              <div class="card">
                ...
                <div class="card-content">
                  ...
                  <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <?php if($customer->is_consumer == 1): ?>
                          <?php echo e($customer->name); ?>

                          <?php else: ?>
                          <?php echo e($customer->consumer_name); ?>
                  ...
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                      ...
                      <a  id="new_registration" href="<?php echo e(url('')); ?>/<?php echo e(config('settings.BackendPath')); ?>/customers/create?ref=assessment" class="btn btn-success btn"> <?php echo e(__('backend.new_registration')); ?>  </a>

                     <div style="display:none;" id="tools"> 

                      <a id="assessment_products_doctor"  href="" class="btn btn-success btn"> <?php echo e(__('backend.assessment_products_by_doctor')); ?>  </a>

                      <a id="assessment_products_delegate" href="" class="btn btn-info btn"> <?php echo e(__('backend.assessment')); ?>  </a>

                      <a id="pricing" href="" class="btn btn-danger btn"> <?php echo e(__('backend.pricing')); ?>  </a>
