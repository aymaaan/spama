              ...
              <div class="card">
                <div class="card-head">
                  <div class="card-header">
                    <h4 class="card-title">  <?php echo e(__('backend.websites')); ?>    </h4>
...
<?php echo Form::model( $data ,[ 'url' =>  config('settings.BackendPath').'/websites/'.$data->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]); ?>  

<?php echo $__env->make('backend.pages.websites.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
$(function () {
    $("#repeat_cat_div").on('click', function (e) {
        e.preventDefault();
        var $self = $(this);
        $self.before($self.prev('div').clone());
        //$self.remove();
