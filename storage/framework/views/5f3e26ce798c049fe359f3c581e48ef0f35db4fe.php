              ...
              <div class="card">
                <div class="card-head">
                  <div class="card-header">
                    ...
                    <?php echo e(__('backend.mother_products')); ?> |  
                    <B> 
...
<?php echo Form::open([ 'route' => 'mother-products.store', 'role' => 'form' , 'class' => 'form' ,  'files' => 'true' ]); ?>  
  
<?php echo $__env->make('backend.pages.mother_products.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
