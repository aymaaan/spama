...
<div class="app-content content">
  <div class="content-body">
    <section class="row">
        ...
        <div class="card">
          <div class="card-head">
            <div class="card-header">
              <h4 class="card-title"> <?php echo e(__('backend.mother_products')); ?> | <B>
              ...
              <div class="heading-elements">
                <a href="<?php echo e(url('')); ?>/<?php echo e(config('settings.BackendPath')); ?>/mother-products/create?cat=<?php echo e($_GET['cat']); ?>">
                  <button class="btn btn-primary btn">
                    <i class="la la-plus-square-o"></i>   <?php echo e(__('backend.add_mother_product')); ?>    </button>
                  </a> </div> 
              <?php endif; ?>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a title="Delete Post" href="<?php echo e(url(config('settings.BackendPath').'/mother-products/'.$row->id.'/delete')); ?>" class="badge badge badge-danger float-right"><i class="la la-trash"></i> </a>
                          <?php endif; ?>
                          ...
                          <?php if($row->status == 1 ): ?>
                          <a title='Block categories' href="<?php echo e(url(config('settings.BackendPath').'/mother-products/approve/'.$row->id.'/0')); ?>" class="badge badge badge-success float-right"><i class="la la-check"></i> </a>
                          <?php else: ?>
                          <a title='Publish categories' href="<?php echo e(url(config('settings.BackendPath').'/mother-products/approve/'.$row->id.'/1')); ?>" class="badge badge badge-danger float-right"><i class="la la-ban "></i> </a>
                          <?php endif; ?>
                          <?php endif; ?>
                           ...
                           <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update_mother_products')): ?> 
                              <a href="<?php echo e(url('')); ?>/<?php echo e(config('settings.BackendPath')); ?>/mother-products/<?php echo e($row->id); ?>/edit" class="badge badge badge-info float-right"><i class="la la-pencil"></i> </a>
                           <?php endif; ?>


                   <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('names_products')): ?> 

                  <a href="<?php echo e(url('')); ?>/<?php echo e(config('settings.BackendPath')); ?>/names-products?cat=<?php echo e($row->id); ?>">
                  <button class="btn btn-success btn">
                  <?php echo e(__('backend.names')); ?>   <span class="badge badge badge-dark  badge-pill float-right mr-2"> <?php echo e(count( $row->names )); ?>  </span></button>
                  </a> 
      ...
      <title><?php echo e(__('backend.mother_products')); ?> | <?php echo e(config('settings.sitename')); ?></title>
