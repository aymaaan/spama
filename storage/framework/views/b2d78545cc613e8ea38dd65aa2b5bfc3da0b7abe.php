...
<?php echo Form::model( $data ,[ 'url' =>  config('settings.BackendPath').'/suppliers/'.$data->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]); ?>  

<?php echo $__env->make('backend.pages.suppliers.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
$(document).ready(function(){
  ...
  <?php if( isset($data) && $data->supplier_type == 'داخلى' ): ?> 
