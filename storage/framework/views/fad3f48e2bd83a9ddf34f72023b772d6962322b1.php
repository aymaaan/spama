...
<?php echo Form::model( $data ,[ 'url' =>  config('settings.BackendPath').'/products/'.$data->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]); ?>  
...
<img src="<?php echo e(url('')); ?>/uploads/products_photos/<?php echo e($data->id); ?>/<?php echo e($photo->photo_name); ?>"   width="150">
</a> 

<br>

<a target="_blank" href="<?php echo e(url('')); ?>/<?php echo e(config('settings.BackendPath')); ?>/products/photos/delete/<?php echo e($photo->id); ?>" style="color:#fff;" type="button" class="btn btn-danger" data-dismiss="modal">Delete</a>
...
<div class="modal fade" id="photoModal<?php echo e($photo->id); ?>" tabindex="-1" role="dialog" aria-labelledby="photoModalLabel<?php echo e($photo->id); ?>" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <img src="<?php echo e(url('')); ?>/uploads/products_photos/<?php echo e($data->id); ?>/<?php echo e($photo->photo_name); ?>"   width="100%">
  ...
  <div class="col-md-3">
    <div class="form-group">
      ...
      <select  id="brand_id" name="brand_id" required  class="form-control">
        ...
        <option <?php if($data->brand_id == $brand->id): ?> selected  <?php endif; ?> title_ar ="<?php echo e($brand->title); ?>" title_en ="<?php echo e($brand->title_en); ?>" serial="<?php echo e($brand->serial); ?>"  value="<?php echo e($brand->serial); ?>"><?php echo e($brand->title); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__currentLoopData = $mother_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <option <?php if($data->mother_product_id == $row->serial): ?> selected  <?php endif; ?>  serial="<?php echo e($row->serial); ?>" title_ar="<?php echo e($row->title); ?>" title_en="<?php echo e($row->title_en); ?>"  value="<?php echo e($row->id); ?>" >
...
<?php $__currentLoopData = $first_names; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <option <?php if($data->first_name == $row->id): ?> selected  <?php endif; ?>   serial="<?php echo e($row->serial); ?>" title_ar="<?php echo e($row->title); ?>" title_en="<?php echo e($row->title_en); ?>"  value="<?php echo e($row->id); ?>" >
  	<?php echo e($row->title); ?>
...
<h4 class="form-section"><i class="la la-commenting"></i> Old <?php echo e(__('backend.titles')); ?> &  SKU </h4>
...
<div class="col-md-4">
  <div class="form-group">
    <label for="projectinput3">   <?php echo e(__('backend.product_name_ar')); ?>   Old    </label>

    <?php echo Form::text('title_ar_old', $data->title_ar_old , ['id'=>'title_ar', 'class' => 'form-control' , 'placeholder'=>  __('backend.arabic_title')   ] ); ?>
...
<div class="col-md-4">
  <div class="form-group">
    <label for="projectinput3"><?php echo e(__('backend.product_name_en')); ?> Old </label>

    <?php echo Form::text('title_en_old', $data->title_en_old , ['id'=>'title_en', 'class' => 'form-control' , 'placeholder'=>  __('backend.english_title')   ] ); ?>
...
<div class="col-md-3">
  <div class="form-group">
    ...
    <?php echo Form::text('sku_old', $data->sku_old , ['id'=>'sku', 'class' => 'form-control' , 'placeholder'=> 'SKU' ] ); ?>
...
<?php $__currentLoopData = $units_data_prices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uniprice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="col-md-2">
    <div class="form-group">
      ...
      <?php echo Form::select('unit_id[]', $units ,  $uniprice->unit_id , ['id'=>'unit_id', 'class' => 'form-control'  ] ); ?>
  ...
  <div class="form-group">
    ...
    <?php echo Form::text('unit_text[]', $uniprice->unit_text , ['id'=>'units', 'class' => 'form-control' , 'placeholder'=> 'Unit Free Text' ] ); ?>
...
<div class="col-md-2">
  <div class="form-group">
    ...
    <?php echo Form::text('customer_price[]', $uniprice->customer_price , ['id'=>'units', 'class' => 'form-control' , 'placeholder'=> __('backend.customer_price') ] ); ?>
...
<div class="col-md-2">
  <div class="form-group">
    ...
    <?php echo Form::text('wholesale_price[]', $uniprice->wholesale_price , ['id'=>'units', 'class' => 'form-control' , 'placeholder'=> __('backend.wholesale_price') ] ); ?>
...
<div class="col-md-2">
  <div class="form-group">
    ...
    <?php echo Form::text('semi_wholesale_price[]', $uniprice->semi_wholesale_price , ['id'=>'units', 'class' => 'form-control' , 'placeholder'=> __('backend.semi_wholesale_price') ] ); ?>
...
<div class="col-md-2">
  <div class="form-group">
    ...
    <?php echo Form::text('ean[]', $uniprice->ean , ['id'=>'units', 'class' => 'form-control' , 'placeholder'=> 'EAN' ] ); ?>
...
<div class="col-md-2">
    <div class="form-group">
      ...
      <?php echo Form::select('unit_id[]', $units ,  null , ['id'=>'unit_id', 'class' => 'form-control' ] ); ?>
...
<div class="col-md-3">
  <div class="form-group">
    ...
    <?php echo Form::text('last_purchase_price', $data->last_purchase_price , ['id'=>'units', 'class' => 'form-control' , 'placeholder'=> __('backend.last_purchase_price') ] ); ?>
...
<div class="col-md-3">
  <div class="form-group">
    ...
    <?php echo Form::text('average_purchase_price', $data->average_purchase_price , ['id'=>'units', 'class' => 'form-control' , 'placeholder'=> __('backend.average_purchase_price') ] ); ?>
...
<div class="col-md-3">
  <div class="form-group">
    ...
    <?php echo Form::select('value_added', ['YES'=>'YES' , 'NO'=>'NO'] , $data->value_added  , ['id'=>'units', 'class' => 'form-control' , 'placeholder'=> __('backend.value_added') ] ); ?>
...
<div class="form-group  col-md-8">
     ...
     <select  name='local_suppliers_id[]' class="select2 form-control" multiple="multiple">
                 ...
                 <?php if( $data->products_local_suppliers->contains('supplier_id' , $row->id)): ?>
...
<?php if( $data->products_complementary->contains('id' , $row->id)): ?>
...
<?php endif; ?>
 ...
 value="<?php echo e($row->id); ?>"><?php echo e($row->title_ar); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div class="col-md-3">
  <div class="form-group">
    ...
    <?php echo Form::date('expiration_date', $data->expiration_date , ['id'=>'expiration_date', 'class' => 'form-control' , 'placeholder'=>  __('backend.expiration_date')   ] ); ?>
...
<div class="col-md-3">
  <div class="form-group">
    ...
    <?php echo Form::date('production_date', $data->production_date , ['id'=>'production_date', 'class' => 'form-control' , 'placeholder'=>  __('backend.production_date')   ] ); ?>
...
<div class="col-md-3">
  <div class="form-group">
    ...
    <?php echo Form::number('loot_number', $data->loot_number , ['id'=>'loot_number', 'class' => 'form-control' , 'placeholder'=>  __('backend.loot_number')   ] ); ?>
...
<div class="row">
  <div class="col-sm-2"><?php echo Form::text('product_package_dimensions_x', $data->product_package_dimensions_x , ['id'=>'product_package_dimensions', 'class' => 'form-control' , 'placeholder'=>  'X'  ] ); ?></div>
  <div class="col-sm-2"><?php echo Form::text('product_package_dimensions_y', $data->product_package_dimensions_y , ['id'=>'product_package_dimensions', 'class' => 'form-control' , 'placeholder'=>  'Y'   ] ); ?></div>
  <div class="col-sm-2"><?php echo Form::text('product_package_dimensions_z', $data->product_package_dimensions_z , ['id'=>'product_package_dimensions', 'class' => 'form-control' , 'placeholder'=> 'Z'   ] ); ?></div>
</div>
...
<?php $__currentLoopData = $products_repositories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row_repository): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="col-md-3">
    <div class="form-group">
      ...
      <?php echo Form::select('repositories[]', $repositories ,  $row_repository->repositories_id , ['id'=>'repositories', 'class' => 'form-control' , 'placeholder'=> '------' ] ); ?>
...
<div class="col-md-2">
  <div class="form-group">
    ...
    <?php echo Form::text('quantity_each_repository[]', $row_repository->quantity_each_repository , ['id'=>'quantity_each_repository', 'class' => 'form-control' , 'placeholder'=>  '------'  ] ); ?>
...
<div class="col-md-2">
  <div class="form-group">
    ...
    <?php echo Form::text('minimum_quantity_each_repository[]', $row_repository->minimum_quantity_each_repository , ['id'=>'minimum_quantity_each_repository', 'class' => 'form-control' , 'placeholder'=>  '------'   ] ); ?>
...
<div class="col-md-2">
  <div class="form-group">
    ...
    <?php echo Form::text('maximum_quantity_each_repository[]', $row_repository->maximum_quantity_each_repository , ['id'=>'maximum_quantity_each_repository', 'class' => 'form-control' , 'placeholder'=>  '------'   ] ); ?>
...
<div class="col-md-2">
  <div class="form-group">
    ...
    <?php echo Form::text('delivery_period_each_repository[]', $row_repository->delivery_period_each_repository , ['id'=>'delivery_period_each_repository', 'class' => 'form-control' , 'placeholder'=>  '------'   ] ); ?>
...
<div class="row">
  <div class="col-sm-2"><?php echo Form::text('product_place_x[]', $row_repository->product_place_x , ['id'=>'product_package_dimensions', 'class' => 'form-control' , 'placeholder'=>  'X'  ] ); ?></div>
  <div class="col-sm-2"><?php echo Form::text('product_place_y[]', $row_repository->product_place_y , ['id'=>'product_package_dimensions', 'class' => 'form-control' , 'placeholder'=>  'Y'   ] ); ?></div>
  <div class="col-sm-2"><?php echo Form::text('product_place_z[]', $row_repository->product_place_z , ['id'=>'product_package_dimensions', 'class' => 'form-control' , 'placeholder'=> 'Z'   ] ); ?></div>
</div>
...
<div class="col-md-4">
  <div class="form-group">
    ...
    <?php echo Form::text('sku_supplier', $data->sku_supplier , ['id'=>'package_unit', 'class' => 'form-control' , 'placeholder'=>  __('backend.sku_supplier')   ] ); ?>
...
<div class="col-md-4">
  <div class="form-group">
    ...
    <?php echo Form::text('total_quantity',  $data->total_quantity , ['id'=>'package_unit', 'class' => 'form-control' , 'placeholder'=>  __('backend.total_quantity')   ] ); ?>
...
<div class="col-md-4">
  <div class="form-group">
    ...
    <?php echo Form::text('minimum_total_quantity',  $data->minimum_total_quantity , ['id'=>'package_unit', 'class' => 'form-control' , 'placeholder'=>  __('backend.minimum_total_quantity')   ] ); ?>
...
<div class="col-md-4">
  <div class="form-group">
    ...
    <?php echo Form::text('maximum_total_quantity', $data->maximum_total_quantity , ['id'=>'package_unit', 'class' => 'form-control' , 'placeholder'=>  __('backend.maximum_total_quantity')   ] ); ?>
...
<div class="col-md-4">
  <div class="form-group">
    ...
    <?php echo Form::text('total_demand_limit', $data->total_demand_limit , ['id'=>'total_demand_limit', 'class' => 'form-control' , 'placeholder'=>  __('backend.total_demand_limit')   ] ); ?>
...
<div class="col-md-4">
  <div class="form-group">
    ...
    <?php echo Form::number('delivery_period_main_repository',  $data->delivery_period_main_repository , ['id'=>'delivery_period_main_repository', 'class' => 'form-control' , 'placeholder'=>  __('backend.delivery_period_main_repository')   ] ); ?>
...
<div class="col-md-4">
  <div class="form-group">
    ...
    <?php echo Form::text('special_price_realted_by_another_product', $data->special_price_realted_by_another_product , ['id'=>'special_price_realted_by_another_product', 'class' => 'form-control'  , 'placeholder'=>  __('backend.special_price_realted_by_another_product')     ] ); ?>
...
<div class="col-md-4">
  <div class="form-group">
    ...
    <?php echo Form::text('cost_price', $data->cost_price , ['id'=>'cost_price', 'class' => 'form-control'  , 'placeholder'=>  __('backend.cost_price')     ] ); ?>
...
<div class="col-md-4">
  <div class="form-group">
    ...
    <option  >-----</option>
                     ...
                     <option <?php if($data->price_related_by_quantity == $row->id ): ?> selected <?php endif; ?>  value="<?php echo e($row->price); ?>">Quantity : <?php echo e($row->quantity); ?> - Price : <?php echo e($row->price); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div class="col-md-4">
  <div class="form-group">
    ...
    <?php echo Form::text('additional_costs_related_by_product', $data->additional_costs_related_by_product , ['id'=>'additional_costs_related_by_product', 'class' => 'form-control'  , 'placeholder'=>  __('backend.additional_costs_related_by_product')     ] ); ?>
...
<div class="col-md-4">
  <div class="form-group">
    ...
    <?php echo Form::text('shipping_charges',  $data->shipping_charges , ['id'=>'shipping_charges', 'class' => 'form-control'  , 'placeholder'=>  __('backend.shipping_charges')     ] ); ?>
...
<div class="col-md-4">
  <div class="form-group">
    ...
    <?php echo Form::text('cod_charges', $data->cod_charges , ['id'=>'cod_charges', 'class' => 'form-control'  , 'placeholder'=>  __('backend.cod_charges')     ] ); ?>
...
?>
                          ...
                          <?php endif; ?>
                            ...
                            <div class="form-group">
                              ...
                              <?php echo Form::number(  $field->name , $value , ['class' => 'form-control' , 'placeholder'=>  $field->label_ar ] ); ?>


                              <?php elseif($field->field_type  == 'textarea'): ?>

                              <?php echo Form::textarea(  $field->name , $value , [ 'rows' => '3' ,'class' => 'form-control' , 'placeholder'=>  $field->label_ar ] ); ?>
...
<?php $__currentLoopData = explode(',',$field->selected_options); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $select_option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <option <?php if($value == $select_option ): ?> selected <?php endif; ?> value="<?php echo e($select_option); ?>"><?php echo e($select_option); ?></option>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<input type="file" multiple="multiple" name="<?php echo e($field->name); ?>[]"  />
                              ...
                              <?php echo Form::text(  $field->name , $value , ['class' => 'form-control' , 'placeholder'=>  $field->label_ar ] ); ?>
