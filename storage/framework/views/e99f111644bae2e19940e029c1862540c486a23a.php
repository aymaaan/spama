              ...
              <div class="card">
                <div class="card-head">
                  <div class="card-header">
                    <h4 class="card-title">    <?php echo e(__('backend.coupons')); ?>    </h4>
...
<?php echo Form::open([ 'route' => 'coupons.store', 'role' => 'form' , 'class' => 'form' ,  'files' => 'true' ]); ?>  
  
<?php echo $__env->make('backend.pages.coupons.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
$(document).ready(function(){
  ...
  $('#checked_all_products').on('click',function(){
     
    if ($('#checked_all_products').is(':checked')) {
      $('#checked_custom_products').hide();
         // alert('checked');  
            
        } else  {
//alert('notchecked');
$('#checked_custom_products').show();  
        }
    ...
    $('#numbers_of_coupons').on('change',function(){

      if( $('#numbers_of_coupons').val() > 1 ) {
        $('#code').hide();
      } else {
        $('#code').show();
      }
