                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update_customers')): ?> 
                           ...
                           <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update_customers')): ?> 
                              <a href="<?php echo e(url('')); ?>/<?php echo e(config('settings.BackendPath')); ?>/customers/details/<?php echo e($row->id); ?>" class="badge badge badge-info float-right"><i class="la la-eye"></i>    </a>
                           <?php endif; ?>
