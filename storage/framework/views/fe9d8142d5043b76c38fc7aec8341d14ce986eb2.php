...
<div class="app-content content">
  <div class="content-body">
    <section class="row">
        ...
        <div class="card">
          <div class="card-head">
            <div class="card-header">
              <h4 class="card-title"> <B>   <?php echo e(__('backend.commercial_activities')); ?>     </B></h4>
              <a class="heading-elements-toggle"><i class="la la-ellipsis-h font-medium-3"></i></a>
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create_commercial_activities')): ?>
              <div class="heading-elements">
                <a href="<?php echo e(url('')); ?>/<?php echo e(config('settings.BackendPath')); ?>/commercial_activities/create">


                  <button class="btn btn-primary btn">
                    <i class="la la-plus-square-o"></i>    <?php echo e(__('backend.add_commercial_activities')); ?>    </button>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_commercial_activities')): ?> 
                          <a title="Delete Post" href="<?php echo e(url(config('settings.BackendPath').'/commercial_activities/'.$row->id.'/delete')); ?>" class="badge badge badge-danger float-right"><i class="la la-trash"></i> </a>
                          <?php endif; ?>



                          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update_commercial_activities')): ?> 
                          <?php if($row->status == 1 ): ?>
                          <a title='Block' href="<?php echo e(url(config('settings.BackendPath').'/commercial_activities/approve/'.$row->id.'/0')); ?>" class="badge badge badge-success float-right"><i class="la la-check"></i> </a>
                          <?php else: ?>
                          <a title='Publish' href="<?php echo e(url(config('settings.BackendPath').'/commercial_activities/approve/'.$row->id.'/1')); ?>" class="badge badge badge-danger float-right"><i class="la la-ban "></i> </a>
                          <?php endif; ?>
                          <?php endif; ?>


                          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update_commercial_activities')): ?> 
                              <a href="<?php echo e(url('')); ?>/<?php echo e(config('settings.BackendPath')); ?>/commercial_activities/<?php echo e($row->id); ?>/edit" class="badge badge badge-info float-right"><i class="la la-pencil"></i> </a>
                           <?php endif; ?>
      ...
      <title> <?php echo e(__('backend.commercial_activities')); ?> | <?php echo e(config('settings.sitename')); ?></title>
